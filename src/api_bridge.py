...
from chord_node_simple import SimpleChordNode, AsyncChordNode
from chord_utils import tokenize_filename, compute_relevance_score
...
class ChordAPIBridge:
    ...
    def __init__(self, node_address: str = "127.0.0.1", node_port: int = 7000):
        ...
        self.chord_node: Optional[SimpleChordNode] = None
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self.chord_node = SimpleChordNode(self.node_address, self.node_port)
